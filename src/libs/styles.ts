import { curry, is, memoizeWith } from "ramda";
...
export const flexValue = memoizeWith(identity, function (
  value: string | number
) {
  return css`
    flex: ${value};
...
export const fontSize = memoizeWith(identity, function (
  value: string | number
) {
  return css`
...
export const hoverColor = memoizeWith(identity, function (value: Colors) {
  return css`
    :hover,
    :hover span {
...
export const stylesForSelector = (
  selector: string | number,
  styles: any
) => css`
  ${selector} {
